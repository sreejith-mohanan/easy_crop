...
class Application():
    def __init__(self, main):
        ...
        self.canvas = Canvas(self.frame, xscrollcommand=self.scrollbar_x.set, yscrollcommand=self.scrollbar_y.set, width=900, height=540, relief=FLAT, bg='white')
        ...
        self.image_on_canvas = self.canvas.create_image(0, 0, anchor=NW, image=self.photo_img)
    ...
    def load_img(self, filename):
        ...
        self.photo_img = ImageTk.PhotoImage(self.img)
        self.canvas.itemconfig(self.image_on_canvas, image=self.photo_img)
    ...
    def create_directories(self):
        ...
        print('creating directories /32x32/ /64x64/ /128x128/ /256x256/')
